...
from ansible_collections.ansible.aruba.tests.unit.compat.mock import patch
from ansible_collections.ansible.aruba.plugins.modules import aruba_config
from ansible_collections.ansible.aruba.tests.unit.modules.utils import set_module_args
...
class TestArubaConfigModule(TestArubaModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.aruba.plugins.modules.aruba_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.aruba.plugins.modules.aruba_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.aruba.plugins.modules.aruba_config.run_commands')
