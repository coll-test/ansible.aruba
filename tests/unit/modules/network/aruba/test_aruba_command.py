...
from ansible_collections.ansible.aruba.plugins.modules import aruba_command
...
class TestArubaCommandModule(TestArubaModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.aruba.plugins.modules.aruba_command.run_commands')
